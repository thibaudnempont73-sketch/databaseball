...
function calcEquipe(data){
  ...
  if(pyth!=null){add(sWinPct(pyth),0.28,{nom:'Pourcentage de victoires théorique',valeur:`${Math.round(pyth*100)}% de victoires attendues cette saison`,detail:'Calculé sur les points marqués et encaissés réels (formule pythagoricienne de Bill James, 1977)',code:'pyth',valVars:{pct:Math.round(pyth*100)},sense:sWinPct(pyth)>=55?'pos':sWinPct(pyth)<=45?'neg':'neu'});}
